...
st.header("")
st.markdown("<h6>Modified for ETH price and Deribit Options (Slightly different from Deribit Option Pricer due to lack of Rho). Feedback are more than welcome, please create a Github Issue for feedback. See project's description and assumptions here: <a href='https://github.com/TFSM00/Black-Scholes-Calculator'>https://github.com/TFSM00/Black-Scholes-Calculator</a></h6>", unsafe_allow_html=True)
